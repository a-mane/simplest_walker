...
% Last Modified 3/18/2009 Josh Petersen. Based on rimlesswheel.m by Pranav Bhounsule


function simplest_walker_11_01
...
steps=2;
k=0.06; fig_note=' (u10=-.19,u30=0)'; fig_title = ['k=', num2str(k), fig_note];

GL_DIM = [M m c I g l w r d gam k];

q10=.2; u10=-.2; % default q10=.2; u10=-.2;
q20=pi; u20=0;
q30=.4; u30=-0.4; % default q30=.4; u30=-.4;
q40=pi; u40=0;
...
k=GL_DIM(11);
Tq1=-k*q1; % -1.9*q1 
% Ta=0; Th=0; Thip=0; % retained since it may be referenced somewhere
